...
class AddTray(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        addBotton = Button(addTrayBottomFrame, text="Add", font=LABEL_FONT, bg="#336857", highlightbackground="#336857",
                           command=lambda: [MyAddfunctions.AddTrayFunct(TofPEntry, DateEntry), refreshEntry(TofPEntry,
                                                                                                            DateEntry)])
        #refreshEntry(TofPEntry)
...
class AddHarvest(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        backButton = tk.Button(harvestBottomFrame, text="Back", bg="#336857", highlightbackground="#336857", width=20,
                               command=lambda: [controller.show_frame(HerbSelect), refreshEntry(TrayIDEntry, AmountEntry
                                                                                                , DateEntry)])
    ...
    def __init__(self, parent, controller):
        ...
        try:
            ...
            backButton = tk.Button(addHerbBottomFrame, text="Back", bg="#336857", highlightbackground="#336857", width=20,
                                   command=lambda: [controller.show_frame(HerbSelect), refreshEntry(HerbTypeEntry,
                                                                                                    HerbIDEntry)])
            ...
            messagebox.showerror("error",'A value error has occurred')
...
class AddOrder(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        backButton = tk.Button(ordersBottomFrame, text="Back",  bg="#336857", highlightbackground="#336857", width=20,
                               command=lambda: [controller.show_frame(Menu),
                                                refreshEntry(OrderIDEntry, VendorIDEntry, HerbIDEntry)])
...
class Search(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def searchHerb():
            ...
            MorgansFunctions.updateTable2(list, "Tray")

            # table 2
            list2 = ttk.Treeview(searchBoxRightFrame)
            list2.pack(pady=30, padx=10)

            list2['columns'] = ('HerbID', 'TofP')

            list2.column("#0", width=0, stretch=NO)
            list2.column("HerbID", anchor=CENTER, width=80)
            list2.column("TofP", anchor=CENTER, width=80)
            ...
            list2.heading("TofP", text="TofP", anchor=CENTER)
            MorgansFunctions.updateTable2(list2, "Herbs")
        ...
        def searchOrder():
            ...
            MorgansFunctions.updateTable2(list, "Orders")
